...
function Studio() {
  ...
  const uploadPic = async () => {
    try {
      ...
      formData.append("folder", "youtube-clone/profile");

      const response = await fetch(
        "https://api.cloudinary.com/v1_1/atbqljuw/image/upload",
        {
          method: "POST",
          body: formData,
        }
  ...
  const uploadVideo = async (videoFile) => {
    ...
    try {
      ...
      formData.append("upload_preset", "youtube_clone");
      formData.append("folder", "youtube-clone/videos");
      ...
      xhr.open(
        "POST",
        "https://api.cloudinary.com/v1_1/atbqljuw/video/upload"
      );
  ...
  const uploadThumbnail = async () => {
    try {
      ...
      formData.append("upload_preset", "youtube_clone");
      formData.append("folder", "youtube-clone/thumbnails");
